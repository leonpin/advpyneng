...
In [4]: print(send_show_command(device_params, 'sh clock', verbose=True)) Вызываем send_show_command Позиционные
аргументы: ({'device_type': 'cisco_ios', 'host': '192.168.100.1', 'username': 'cisco', 'password': 'cisco',
'secret': 'cisco'}, 'sh clock') *14:01:07.353 UTC Mon Feb 26 2018

In [5]: print(send_show_command(device_params, 'sh clock', verbose=True)) Вызываем send_show_command Позиционные
аргументы: ({'device_type': 'cisco_ios', 'host': '192.168.100.1', 'username': 'cisco', 'password': 'cisco',
'secret': 'cisco'}, 'sh clock') *15:09:45.152 UTC Fri Oct 18 2019

In [6]: print(send_show_command(device_params, command='sh clock', verbose=True)) Вызываем send_show_command
Позиционные аргументы: ({'device_type': 'cisco_ios', 'host': '192.168.100.1', 'username': 'cisco', 'password':
'cisco', 'secret': 'cisco'},) Ключевые аргументы: {'command': 'sh clock'} *15:10:09.222 UTC Fri Oct 18 2019

In [7]: print(send_show_command(params=device_params, command='sh clock', verbose=True)) Вызываем send_show_command
Ключевые аргументы: {'params': {'device_type': 'cisco_ios', 'host': '192.168.100.1', 'username': 'cisco', 'password':
'cisco', 'secret': 'cisco'}, 'command': 'sh clock'} *15:10:28.524 UTC Fri Oct 18 2019
